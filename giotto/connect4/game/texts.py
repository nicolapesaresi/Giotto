...
class XOSprite(TextSprite):
    ...
    def __init__(self, sign: str, row:int, col: int):
        """Instantiates sprite.
        Args:
            sign: 'x' or 'o'.
            row: row on the playing board (1-7).
            col: col on the playing board (1-7).
        """
        ...
        pos = (settings.GRID_X0 + col*settings.CELL_WIDTH, settings.GRID_Y0 + row*settings.CELL_HEIGHT)
