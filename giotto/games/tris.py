...
from giotto.tris.env.env import TrisEnv
from giotto.tris.game.texts import XOSprite, TurnSprite, ResultSprite
from giotto.tris.game.gameover_screen import GameOver
from giotto.tris.game.main_menu import MainMenu
from giotto.tris.game.buttons import PlayerType
...
class PygameRenderer:
    ...
    def setup_pygame(self):
        ...
        pygame.display.set_caption("Play Giotto at TicTacToe")
    ...
    def check_move_click(self, event) -> int|None:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if settings.GRID_X0 < x < settings.GRID_X1 and settings.GRID_Y0 < y < settings.GRID_Y1:
                ...
                cell = 9
            # return click cell if it's a valid action
    ...
    def draw_screen(self):
        ...
        self.load_gamescreen()
        # grid
        pygame.draw.line(self.screen, settings.GRID_COLOR, (settings.GRID_X1, settings.GRID_Y0), (settings.GRID_X1, settings.GRID_Y3), settings.GRID_WIDTH)
        pygame.draw.line(self.screen, settings.GRID_COLOR, (settings.GRID_X2, settings.GRID_Y0), (settings.GRID_X2, settings.GRID_Y3), settings.GRID_WIDTH)
        pygame.draw.line(self.screen, settings.GRID_COLOR, (settings.GRID_X0, settings.GRID_Y1), (settings.GRID_X3, settings.GRID_Y1), settings.GRID_WIDTH)
        pygame.draw.line(self.screen, settings.GRID_COLOR, (settings.GRID_X0, settings.GRID_Y2), (settings.GRID_X3, settings.GRID_Y2), settings.GRID_WIDTH)
        # player moves
        moves = Group()
